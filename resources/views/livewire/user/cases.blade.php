                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true" id="kt-toolbar-filter">
                                <!--begin::Header-->
                                <div class="px-7 py-5">
                                    <div class="fs-4 text-dark fw-bolder">Surgeons</div>
                                </div>
                                <!--end::Header-->
                                <!--begin::Separator-->
                                ...
                                <!--end::Separator-->
                                    ...
                                    <div class="px-7 py-5">
                                            ...
                                            <div class="d-flex flex-column flex-wrap fw-bold" data-kt-customer-table-filter="payment_type">
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-check form-check-custom">
                                                        <input class="form-check-input h-20px w-20px" wire:model="surgeonfilter" type="checkbox" value="{{ $value->id }}"/>
                                        ...
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <button type="submit" wire:click="applySurgeonfilter" class="btn btn-primary" data-kt-menu-dismiss="true" data-kt-customer-table-filter="filter">Apply</button>
                                        </div>
                                        <!--end::Actions-->
                                    </div>
                                    <!--end::Content-->
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_tables">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-8 text-uppercase gs-0">
                                ...
                                <th class="min-w-70px">Standby</th>
                                <th class="min-w-70px">Sur. Date</th>
                                <th class="min-w-70px">Clearance</th>
                                <th class="min-w-70px">Submitted To Facility</th>
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="myselection"  wire:change="changeCaseStatus({{ $case->id }}, $event.target.value)">
                                        @foreach ($caseStatus as  $key => $value) 
                                            <option value="{{$key}}" {{ $key === $case->case_status ? 'selected' : '' }} > 
                                                {{$value['text']}}
                                             </option> 
                                        @endforeach
                                    </select>
